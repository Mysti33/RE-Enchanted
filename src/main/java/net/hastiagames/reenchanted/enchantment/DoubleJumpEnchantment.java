...
public class DoubleJumpEnchantment extends Enchantment {
	private static final EnchantmentCategory ENCHANTMENT_CATEGORY = EnchantmentCategory.create("reenchanted_double_jump",
	...
	protected boolean checkCompatibility(Enchantment enchantment) {
		return super.checkCompatibility(enchantment) && !List.of(ReenchantedModEnchantments.STEP_ASSIST.get()).contains(enchantment);
	}
